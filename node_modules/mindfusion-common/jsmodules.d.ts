...
/// <reference path="./modules/jscommon.d.ts" />
/// <reference path="./modules/jscollections.d.ts" />
/// <reference path="./modules/jsui.d.ts" />
...
declare module "mindfusion-common/jsmodules"
{
	export = MindFusion;
}