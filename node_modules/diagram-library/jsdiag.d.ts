...
declare namespace MindFusion.Diagramming
{
	...
	class Diagram extends MindFusion.Drawing.Canvas
	{
		...
		*/
		...
		getActiveItemHandlesStyle(): HandlesVisualStyle;
		/** Sets the visual style of adjustment handles of the active item. */
		setActiveItemHandlesStyle(value: HandlesVisualStyle): void;
		/** Gets the visual style of adjustment handles of selected items. */
		getSelectedItemHandlesStyle(): HandlesVisualStyle;
		/** Sets the visual style of adjustment handles of selected items. */
		setSelectedItemHandlesStyle(value: HandlesVisualStyle): void;
		/** Gets the visual style of disabled adjustment handles. */
		getDisabledItemHandlesStyle(): HandlesVisualStyle;
		/** Sets the visual style of disabled adjustment handles. */
		setDisabledItemHandlesStyle(value: HandlesVisualStyle): void;
	...
	class Style
	{
		...
		setBrush(value: any): void;
		/** Gets  the brush used to fill the interior of selected diagram items. */
		getSelectedBrush(): any;
		/** Sets  the brush used to fill the interior of selected diagram items. */
		setSelectedBrush(value: any): void;
		...
		setStroke(value: string): void;
		/** Gets the brush used to stroke the borders of selected diagram items. */
		getSelectedStroke(): any;
		/** Sets the brush used to stroke the borders of selected diagram items. */
		setSelectedStroke(value: any): void;
		...
		setShadowColor(value: string): void;
		/** Gets the brush used to fill the the caption bar of nodes. */
		getCaptionBackBrush(): any;
		/** Sets the brush used to fill the the caption bar of nodes. */
		setCaptionBackBrush(value: any): void;
	...
	class Theme
	{
		 ...
		 * @return An instance of the Theme class.
		*/
		static getBlue(): Theme;
		/** Gets the built-in Business theme.
		 * @return An instance of the Theme class.
		*/
		static getBusiness(): Theme;
		/** Gets the built-in Grey theme.
		 * @return An instance of the Theme class.
		*/
		static getGrey(): Theme;
		/** Gets the built-in Green theme.
		 * @return An instance of the Theme class.
		*/
		static getGreen(): Theme;
		/** Gets the built-in Light theme.
		 * @return An instance of the Theme class.
		*/
		static getLight(): Theme;
		/** Gets the built-in Pastel theme.
		 * @return An instance of the Theme class.
		*/
		static getPastel(): Theme;
		/** Gets the built-in Peach theme.
		 * @return An instance of the Theme class.
		*/
		static getPeach(): Theme;
		/** Gets the built-in Standard theme.
		 * @return An instance of the Theme class.
		*/
		static getStandard(): Theme;
	...
	class Events
	{
		...
		static linkTextEditing: string;
		/** Raised when the user starts to edit the text of a link. The event handlers get a LinkEventArgs instance that contains data about this event. */
		static cellTextEditing: string;
	}
	...
	class NodeListView extends MindFusion.Drawing.Canvas
	{
		...
		*/
		...
		/** Gets the color used to paint text in the NodeListView control. */
		getTextColor(): string;
		/** Sets the color used to paint text in the NodeListView control. */
		setTextColor(value: string): void;
	...
	class StyleBuilder
	{
		...
		*/
		 ...
		 * @param value 
		*/
		selectedBrush(value: any): StyleBuilder;
		/** Sets the brush used to fill the diagram background.
		 * @param value 
		*/
		...
		*/
		 ...
		 * @param value 
		*/
		selectedStroke(value: any): StyleBuilder;
		/** Sets the line width applied when stroking the frame of diagram items.
		 * @param value 
		*/
		...
		*/
		 ...
		 * @param value 
		*/
		captionBackBrush(value: any): StyleBuilder;
		/** Sets a list containing all effects applied to the nodes of this diagram.
		 * @param value 
		*/
	...
	class HandlesVisualStyle
	{
		 ...
		 * @param diagram The parent diagram for this style.
		*/
		constructor(diagram: Diagram);
		/** Gets the brush used to fill the interior of selection handles. */
		getHandleBrush(): any;
		/** Sets the brush used to fill the interior of selection handles. */
		setHandleBrush(value: any): void;
		/** Gets the brush used to fill the interior of the rotation handle. */
		getRotationHandleBrush(): any;
		/** Sets the brush used to fill the interior of the rotation handle. */
		setRotationHandleBrush(value: any): void;
		/** Gets the brush used to fill the interior of shape control points. */
		getControlHandleBrush(): any;
		/** Sets the brush used to fill the interior of shape control points. */
		setControlHandleBrush(value: any): void;
		/** Gets the brush used to draw hatch frames. */
		getHatchBrush(): any;
		/** Sets the brush used to draw hatch frames. */
		setHatchBrush(value: any): void;
		/** Gets the brush used to draw selection frames for the MoveOnly style. */
		getPatternBrush(): any;
		/** Sets the brush used to draw selection frames for the MoveOnly style. */
		setPatternBrush(value: any): void;
		/** Gets the color used to stroke the frame of diagram items. */
		getHandleStroke(): string;
		/** Sets the color used to stroke the frame of diagram items. */
		setHandleStroke(value: string): void;
		/** Gets the line width applied when stroking the frame of diagram items. */
		getHandleStrokeThickness(): number;
		/** Sets the line width applied when stroking the frame of diagram items. */
		setHandleStrokeThickness(value: number): void;
		/** Gets the color used to stroke dashed selection frames. */
		getDashStroke(): string;
		/** Sets the color used to stroke dashed selection frames. */
		setDashStroke(value: string): void;
		/** Gets the line width applied when stroking dashed selection frames. */
		getDashStrokeThickness(): number;
		/** Sets the line width applied when stroking dashed selection frames. */
		setDashStrokeThickness(value: number): void;
		/** Returns a builder object, associated with this HandlesVisualStyle instance.
		 * @return A Builder instance.
		*/
		init(): HandlesVisualStyle;
		/** Returns a builder object.
		 * @return A Builder instance.
		*/
		static With(): HandlesVisualStyle;
	}
	/** A builder class for the HandlesVisualStyle class. */
	class HandlesVisualStyleBuilder
	{
		/** Creates a new HandlesVisualStyle instance with the specified properties.
		 * @return A HandlesVisualStyle instance.
		*/
		create(): HandlesVisualStyle;
		/** Sets the brush used to fill the interior of selection handles.
		 * @param value 
		*/
		handleBrush(value: any): HandlesVisualStyleBuilder;
		/** Sets the brush used to fill the interior of the rotation handle.
		 * @param value 
		*/
		rotationHandleBrush(value: any): HandlesVisualStyleBuilder;
		/** Sets the brush used to fill the interior of shape control points.
		 * @param value 
		*/
		controlHandleBrush(value: any): HandlesVisualStyleBuilder;
		/** Sets the brush used to draw hatch frames.
		 * @param value 
		*/
		hatchBrush(value: any): HandlesVisualStyleBuilder;
		/** Sets the brush used to draw selection frames for the MoveOnly style.
		 * @param value 
		*/
		patternBrush(value: any): HandlesVisualStyleBuilder;
		/** Sets the color used to stroke the frame of diagram items.
		 * @param value 
		*/
		handleStroke(value: string): HandlesVisualStyleBuilder;
		/** Sets the line width applied when stroking the frame of diagram items.
		 * @param value 
		*/
		handleStrokeThickness(value: number): HandlesVisualStyleBuilder;
		/** Sets the color used to stroke dashed selection frames.
		 * @param value 
		*/
		dashStroke(value: string): HandlesVisualStyleBuilder;
		/** Sets the line width applied when stroking dashed selection frames.
		 * @param value 
		*/
		dashStrokeThickness(value: number): HandlesVisualStyleBuilder;
	}
